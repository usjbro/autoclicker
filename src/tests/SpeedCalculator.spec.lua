...
return function()
	...
	describe("CalculateMaxSpeed", function()
		it("should equal base speed at 0 score", function()
			expect(SpeedCalculator.CalculateMaxSpeed(0)).to.equal(SpeedCalculator.BASE_WALK_SPEED)
		end)

		it("should increase with score but cap at a bounded value", function()
	...
	describe("CalculateEffectiveSpeed", function()
		it("should return base speed when useBaseSpeed is true, regardless of score/slider", function()
