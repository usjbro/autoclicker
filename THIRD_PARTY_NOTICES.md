...
- Vendored at: commit `26a5247631279154c74425b94583c189b8447d0f` (`wally.toml` version 0.4.1)
- Copyright Roblox Corporation
- License: Apache License, Version 2.0 (full text below)
- Unmodified from upstream -- if that changes, note it here per the License's
